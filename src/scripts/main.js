...
const learnMore1 = addedContent1.querySelector('.about-brand__learn-more');
...
const learnMore2 = addedContent2.querySelector('.about-creators__learn-more');
...
const learnMore3 = addedContent3.querySelector('.tooth-powder__learn-more');
